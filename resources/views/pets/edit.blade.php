        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-black">
                    <p class="text-center font-bold">EDIÇÃO DE PET</p>
                        ...
                        <div class="grid grid-cols-2 gap-4 justify-items-center ">
                            ...
                            <div class="w-full mb-4">
                                ...
                                <select name="especie"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                                    required>
                                    <option selected>{{ $pet->especie }}</option>
                            ...
                            <div class="mb-4 mt-6 grid grid-cols-4 px-4 py-1 border rounded-lg border-black">
                                ...
                                <input type="radio" id="sexo" name="sexo" value="M" {{ old('sexo', $pet->sexo) == 'M' ? 'checked' : '' }}
                                ...
                                <input type="radio" id="sexo" name="sexo" value="F" {{ old('sexo', $pet->sexo) == 'F' ? 'checked' : '' }}
                            ...
                            <div class="w-full mb-4">
                                ...
                                <input type="date" id="nascimento" name="nascimento" value="{{ $pet->nascimento }}"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                                    required>
                            </div>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <input type="text" id="tutor" name="tutor" value="{{ $pet->tutor }}"
                                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
                                    required>
                            </div>
                        </div>
